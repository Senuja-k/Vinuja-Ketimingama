    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh", backgroundColor: "#fff", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="home-content-wrapper" style={{ paddingTop: "120px", flex: 1, paddingBottom: "80px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 25px" }}>
          ...
          <div style={{ marginTop: '20px', padding: '12px 0', borderTop: '1px solid #eee', borderBottom: '1px solid #eee' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                ...
                <div>
                  <h4 style={{ fontSize: '13px', fontWeight: '600', color: '#374151', marginBottom: '2px' }}>Delivery</h4>
                  <p style={{ fontSize: '13px', color: '#6b7280', lineHeight: '1.4', margin: '0' }}>
                    {product?.delivery_timeline ? `${product.delivery_timeline} days` : 'Standard delivery'} • Rs. {product?.delivery_fee || 0} fee
                  </p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                ...
                <div>
                  <h4 style={{ fontSize: '13px', fontWeight: '600', color: '#374151', marginBottom: '2px' }}>Returns</h4>
                  <p style={{ fontSize: '13px', color: '#6b7280', lineHeight: '1.4', margin: '0' }}>
                    {product?.return_policy_days || 14} days return policy
                  </p>
                </div>
              </div>
          ...
          <div style={{ marginTop: '30px', borderTop: '1px solid #eee', paddingTop: '20px' }}>
            <div style={{ marginBottom: '24px' }}>
              <h2 style={{ fontSize: '32px', fontWeight: '800', color: '#111', marginBottom: '18px' }}>Product Description</h2>
              <div style={{ 
                fontSize: '16px', 
                lineHeight: '1.7', 
                color: '#555',
